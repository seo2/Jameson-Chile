  ...
  <body>
	...
	<section id="contenido">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<img src="assets/img/botella.png" class="img-responsive">
				</div>
				<div class="col-md-6">
							...
							<form class="form-horizontal" method="post" action="ajax/registrar.php" id="form-registro">
								...
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-10">
										<div class="checkbox">
											<label>
												<input type="checkbox" name="check_info"> Deseo recibir información sobre Pernod Ricard
											</label>
										</div>
									</div>
								</div>
				...
				<div class="col-md-3">
					<div id="bases">
						<h3>Bases<br>del concurso<br>Jameson Irish Whiskey</h3>
					...
					<a href="javascript:void(0);" class="btn btn-primary">Más Información</a>
				</div>
			</div>
		</div>
	</section>
